...
totalPages:1,
 ...
 handleTabsItemChange(e){
  ...
  if (tabs[1].isActive){
    ...
    this.getGoodsList(this.QueryParams.query,this.QueryParams.pagenum,this.QueryParams.pagesize,this.data.tabs_now);
  ...
  onLoad: function (options) {
    ...
    this.setData({
      //拼接数组
      query_name: '检索 > '+ options.query
    })
  },

  //获取商品列表数据
  getGoodsList(query,pagenum,pagesize,tabs_now){
        wx.showLoading();
